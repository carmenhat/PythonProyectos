...
import streamlit as stfig_data_completeness = px.line(
    movies_with_country_data,
    x='year',
    y='percent_with_data',
    title="Porcentaje de películas con datos de país por año",
    markers=True
)
fig_data_completeness.update_layout(
    xaxis_title="Año",
    yaxis_title="% películas con datos de país"
)
st.plotly_chart(fig_data_completeness, use_container_width=True)
import os
